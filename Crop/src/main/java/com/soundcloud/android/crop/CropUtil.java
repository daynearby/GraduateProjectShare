...
class CropUtil {
    ...
    //在cache下的文件夹,没有外置卡,那么就是内置的cache的目录,并且创建一个image的文件夹
    ...
    public static File CreateImageFile(Context context){
        ...
        if (checkSdCard()){//存在
            ...
            path = context.getExternalCacheDir().getAbsolutePath()+DIRECTORY;
            ...
            path = context.getCacheDir().getAbsolutePath()+DIRECTORY;
