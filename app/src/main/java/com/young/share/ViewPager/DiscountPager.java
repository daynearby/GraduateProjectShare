...
public class DiscountPager extends BasePager {
    ...
    public void initView() {
        ...
        discAdapter = new DiscountAdapter(ctx);
...
//                                Toast.makeText(ctx, R.string.no_more_messages, Toast.LENGTH_SHORT).show();
    ...
    public void getRemoteData() {
        ...
        BmobApi.AsyncFunction(ctx, params, BmobApi.GET_RECENTLY_DICOUNT,
    ...
    private class itemClick implements AdapterView.OnItemClickListener {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            ...
            LocationUtils.startActivity(ctx, bundle, DiscoutDetailActivity.class);
        }
    }
}
