package com.young.share.network.ssl;
...
public class EasySSLSocketFactory implements LayeredSocketFactory {
    ...
    private static SSLContext createEasySSLContext() throws IOException {
        try {
        	...
        	InputStream clientStream = ApplicationConfig.getInstance().getResources().openRawResource(R.raw.share_ket_storyssl);
        	char[] password = "sdf554sdf4c".toCharArray();
	        ...
	        instream = ApplicationConfig.getInstance().getResources().openRawResource(R.raw.sharebmob);

	        try {
	            trustStore.load(instream, "sdf554sdf4c".toCharArray());
	        } catch (Exception e) {
	            e.printStackTrace();
	        } finally {
