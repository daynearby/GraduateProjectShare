...
// TODO: 2016-04-19 修改显示图片的控件，最多两行两列 
        ...
        MultiImageView multiImageView = holder.getView(R.id.mv_post_message_images);
...
/*显示视频*/
        setupVideo(remoteModel, videoIm);
//
...
//文字内容
     ...
     */
    private void setImages(final MultiImageView multiImageView, TextView imagesNumber, final RemoteModel remoteModel) {
...
//
     ...
     * @param videoPreview
     */
    private void setupVideo(RemoteModel remoteModel, final ImageView videoPreview) {
        //视频的处理,这里显示视频截图
