 ...
 */
public class ThumGridViewAdapter extends BaseAdapter {
     ...
     * @param isUpload
     */
    public ThumGridViewAdapter(Activity mActivity, GridView gv, boolean isUpload) {
...
//                    bundle.putSerializable(Contants.INTENT_IMAGE_INFO_LIST,);
