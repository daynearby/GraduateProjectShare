 ...
 */
public class mEditView extends EditText implements View.OnFocusChangeListener, TextWatcher {
    /**
     * 删除按钮的引用
     */
    ...
    private void init() {
        ...
        if (mClearDrawable == null) {
            ...
            mClearDrawable = getResources().getDrawable(R.drawable.icon_delete_text);
        }
